...
showNotification:function(e,a,t){
	/*type=["","info","danger","success","warning","rose","primary"],*/
	/*color=Math.floor(6*Math.random()+1),*/
	color = t,

	$.notify({icon:"add_alert",
		message:"Welcome to hilary soyemi <b>Material Dashboard Pro</b> - a beautiful admin panel for every web developer."},
